 ...
 */
class TopStoriesFragment : Fragment(), Callback<TopStories> {
    ...
    override fun onCreateView(
        ...
        var view:View = inflater.inflate(R.layout.fragment_top_stories, container, false)
        recyclerView = view.findViewById(R.id.recycler_view)
        recyclerView!!.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
        ApiClient.apiInterface.getTopStories(HttpConstants.API_KEY).enqueue(this)
        return  view
    }
